...
const ApprovedSellers = () => {
    ...
    const handleRejectSeller = async () => {
        ...
        try {
            ...
            await rejectSellerApi(selectedSeller.id, rejectionReason.trim());
            showToast(`Successfully rejected seller ${sellerName}.`);
                            ...
                            <div className="flex-1 flex flex-col h-full overflow-hidden min-w-0">
                                ...
                                <div className="bg-emerald-900 text-white px-6 py-4 flex justify-between items-center shrink-0">
                                    <div>
                                        ...
                                        <p className="text-xs text-emerald-200 mt-0.5">Seller ID: #{seller.id} • Approved</p>
                                    </div>
                                    <button
                                ...
                                <div className="flex-1 overflow-y-auto p-6 bg-gray-50/30">
                                    ...
                                    {/* Rejection input box inside modal body */}
                                    {isRejecting && (
                                        <div className="mt-6 p-5 bg-red-50/50 border border-red-100 rounded-2xl shadow-sm space-y-3 animate-in slide-in-from-bottom-2 duration-300">
                                            ...
                                            <textarea
                                                rows={3}
                                                placeholder="Provide feedback to the seller on why their application is being rejected..."
                                                value={rejectionReason}
                                                onChange={(e) => setRejectionReason(e.target.value)}
                                                className="w-full px-4 py-2.5 border border-red-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm bg-white resize-none"
                                            />
                                        </div>
                                    )}
                                </div>
                                    ...
                                    {isRejecting ? (
                                        <>
                                            ...
                                            <button
                                                ...
                                                className="px-5 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-xl transition-all flex items-center justify-center min-w-[120px] shadow-md hover:shadow-red-500/20 active:scale-95 border-none cursor-pointer"
                                            >
                                        ...
                                        <>
                                            <button
                                                ...
                                                className="px-5 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-xl transition-colors cursor-pointer border-none shadow-sm active:scale-95"
                                            >
                                                Reject Seller
                                            </button>
                                            <button
