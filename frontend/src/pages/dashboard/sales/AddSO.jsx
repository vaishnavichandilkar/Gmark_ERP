                                        ...
                                        <div className="max-h-[220px] overflow-y-auto custom-scrollbar">
                                            {filteredCustomers.length > 0 ? (
                                                filteredCustomers.map(customer => (
                                                    ...
                                                    >
                                                        <span className="font-bold text-[#111827]">{customer.accountName}</span>
                                                        <span className="text-[11px] text-gray-400">{customer.customerCode || 'No Code'} • {customer.city || 'No City'}</span>
                                                    </button>
                                                ))
                                            ) : (
