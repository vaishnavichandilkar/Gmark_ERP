...
const SalesInvoice = () => {
    ...
    const handleImportExcel = async (formData) => {
        try {
            const response = await salesInvoiceService.importInvoices(formData);
            ...
            {createPortal(
                <>
                            ...
                            <div className="relative bg-white w-full max-w-[550px] rounded-[24px] shadow-2xl p-10 space-y-8 animate-in zoom-in-95 duration-300 border border-gray-100 font-outfit text-left">
                                ...
                                <div className="space-y-3">
                                    {importSummary.successful > 0 && (
                                        <button
                                            onClick={() => downloadBase64File(importSummary.successFile, 'Sales_Invoice_Import_Success_Report.xlsx')}
                                    ...
                                    {importSummary.failed > 0 && (
                                        <button
                                            onClick={() => downloadBase64File(importSummary.errorFile, 'Sales_Invoice_Import_Error_Report.xlsx')}
                    ...
                    <ImportModal
                        ...
                        sampleFileName="Sales_Invoice_Import_Sample.xlsx"
                    />
