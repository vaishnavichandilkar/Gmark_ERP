...
const ViewHSN = ({ initialData, onBack, onEdit }) => {
        ...
        <div className="flex flex-col w-full h-full animate-in fade-in duration-300">
            ...
            <div className="bg-white rounded-[12px] border border-[#E5E7EB] shadow-sm flex flex-col w-full animate-in fade-in slide-in-from-left-2 duration-300">
                ...
                <div className="flex justify-between items-center px-6 py-5 border-b border-[#E5E7EB]">
                    <h2 className="text-[18px] font-bold text-[#111827]">View HSN Details</h2>
                ...
                <div className="p-6 md:p-8 flex flex-col">
                    ...
                    {/* Header Section */}
                    <div className="mb-6">
                        <h1 className="text-[28px] md:text-[32px] font-bold text-[#111827] mb-2">{data.code}</h1>
                        <div className="flex gap-2">
                            <div className={`inline-flex items-center px-4 py-1.5 rounded-[100px] text-[14px] font-medium ${data.isActive ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                    ...
                    <div className="border border-[#E5E7EB] rounded-[8px] overflow-hidden flex flex-col w-full">
                        ...
                        <InfoTableRow 
                            ...
                            label2="Status:" value2={data.isActive ? 'Active' : 'Inactive'} 
                        />
